...
//           <img src={logo} className="h-24 mb-[300%]" alt="" />
//         </div>
//         <nav>
//           <ul className="flex flex-col">
//             <li
//               className={`cursor-pointer mb-4 ${
//                 activeNavItem === "Courses" ? "font-bold" : ""
//               }`}
//             >
//               <Link to="/">
//                 <FaHome className="ml-6" />
//                 Home
//               </Link>
//             </li>
//             {isAdmin ? (
...
//                 >
//                   <FaUserAstronaut className="ml-6" />
...
//                 <li
//                   className={`cursor-pointer mb-4 ${
//                     activeNavItem === "Students" ? "font-bold" : ""
//                   }`}
...
//                 <li
//                   className={`cursor-pointer mb-4 ${
//                     activeNavItem === "Assignments" ? "font-bold" : ""
//                   }`}
...
//                 <li
//                   className={`cursor-pointer mb-4 ${
//                     activeNavItem === "Grades" ? "font-bold" : ""
//                   }`}
